...
Gender: student's gender (Options: Male or Female)

Nationality: student's nationality (Options: Kuwait, Lebanon, Egypt, Saudi Arabia, USA, Jordan, Venezuela, Iran, Tunis, Morocco, Syria, Palestine, Iraq, Lybia)

Place of birth: student's country of birth (Options: Kuwait, Lebanon, Egypt, Saudi Arabia, USA, Jordan,
Venezuela, Iran, Tunis, Morocco, Syria, Palestine, Iraq, Lybia)

Educational Stages: student's current educational level (Options: Lower Level, Middle School, High School)

Grade Levels: student's current grade level (Options: G-01, G-02, G-03, G-04, G-05, G-06, G-07, G-08, G-09, G-10, G-11, G-12)

Section ID: student's current classroom (Options: A, B, C)

Topic: course topics available (Options: English, Spanish, French, Arabic, IT, Math, Chemistry, Biology, Science, History, Quran, Geology)

Semester: semester of current school year (Options: First, Second)

Parent responsible for student: (Options: mom, father)

Raised hands: amount of times a student raises their hand during class (Options: 1-100) \

Visited resources: amount of times a student accesses course content (Options: 1-100) 

Viewing announcements: amount of times a student checks new announcements (Options: 1-100)

Discussion groups: amount of times a student participates in discussion groups (Options: 1-100)

Parent Answering Survey: amount of surveys provided by the school answered by parents (Options: 1-100) 

Parent School Satisfaction: amount of parent satisfaction (Options: 1-100)

Student Absence Days: amount of days each student was absent during the school year (Options: above-7, under-7) 
